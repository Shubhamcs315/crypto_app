import { Box, Button, Container, HStack, Radio, RadioGroup, VStack,Text, Image, StatLabel, Stat, StatHelpText, StatArrow, Badge, Progress } from '@chakra-ui/react'
...
if(error) return<ErrorComp err={"Error while fetching coin"}/>
