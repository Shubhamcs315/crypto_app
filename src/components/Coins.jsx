...
if(error) return<ErrorComp err={"Error while fetching coins"}/>
    ...
    <Container maxW={"container.xl"}>
        ...
        <HStack wrap={"wrap"} justifyContent={"space-evenly"}>
          ...
          coins.map((i) =>(
            ...
            <CoinCard key={i.id} id={i.id} price={i.current_price} name={i.name} img={i.image} symbol={i.symbol} url={i.url} currencySymbol={currencySymbol}/>
          ))}
        </HStack>
